    ...
    <div className="container">
      <div className="not-found__container">
        <div className="not-found__pictures">
          <img className="not-found__image not-found__image--first" src={FourImage} alt="four" />
          <img className="not-found__image not-found__image--cactus" src={CactusImage} alt="cactus" />
          <img className="not-found__image not-found__image--second" src={FourImage} alt="four" />
        </div>
